...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-60 bg-[#0F2460] flex flex-col z-40">
      {/* Logo */}
      ...
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        {/* Admin section — visível apenas para admins (hardcoded por ora) */}
      ...
      <div className="px-3 py-4 border-t border-white/10 space-y-1">
        ...
        <div className="flex items-center gap-3 px-3 py-2.5 mt-2">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-white text-xs font-medium truncate">Bruno Sard.</p>
            <p className="text-[#64748B] text-[10px] truncate">Admin</p>
          </div>
          <button
            onClick={handleLogout}
            disabled={isPending}
            title="Sair"
            className="text-[#475569] hover:text-white transition-colors disabled:opacity-50 flex-shrink-0"
          >
